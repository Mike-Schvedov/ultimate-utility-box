package com.mikeschvedov.ultimate_utility_box.network.connectivity
...
/*
*  === How to use ===
* create an instance in the view-model and pass in a connectivity manager instance
* create an observer in the main activity : mainViewModel.liveInternetChecker.observe(this, {isNetworkAvailable ->
*   if(isNetworkAvailable) doSomething()   })
* */
class LiveNetworkMonitor(private val connectivityManager: ConnectivityManager) : LiveData<Boolean>()  {
